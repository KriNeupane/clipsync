                ...
                <div className="max-h-[300px] overflow-y-auto">
                    {files.length === 0 ? (
                        <div className="py-8 text-center">
                            <p className="text-[15px] text-gray-400">No files yet</p>
                        </div>
                    ) : (
                        <ul className="pl-4">
                            {files.map((file, i) => (
                                <li key={i} className="flex items-center justify-between py-3 pr-4 border-b border-gray-100 dark:border-white/5 last:border-0 hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors group">
                                    <div className="flex items-center gap-3 overflow-hidden flex-1 mr-4">
                                        ...
                                        <span className="text-[17px] text-black dark:text-white truncate">{file}</span>
                                    </div>
